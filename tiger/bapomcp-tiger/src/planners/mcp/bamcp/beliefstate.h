...
public:
    ...
    STATE* CreateSamplebyindex(const SIMULATOR& simulator, int i) const;

    STATE* CreateSampleWithProb(const SIMULATOR& simulator) const;
    ...
    STATE* GetSampleByIndex(int index) const{ return Samples[index];}
