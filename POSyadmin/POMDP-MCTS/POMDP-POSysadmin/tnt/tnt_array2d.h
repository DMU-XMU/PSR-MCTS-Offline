...
class Array2D {
	...
	inline	operator T*(); // returns the entire data_   - Adrian.
	inline	operator const T*();
...
template <class T>
Array2D<T> & Array2D<T>::operator=(const Array2D<T> &A) { return ref(A); }
...
template <class T>
inline Array2D<T>::operator T**() { return &(v_[0]); }

template <class T>
inline Array2D<T>::operator const T**() { return &(v_[0]); }

template <class T>
inline Array2D<T>::operator T*() { return data_; }

template <class T>
inline Array2D<T>::operator const T*() { return data_; }
