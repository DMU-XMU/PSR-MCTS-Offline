...
public:
	...
	symList2IntMap *getHistcout(symList2Vec2Map *divideData,int CUTOFF,string txtname);
	symList* getHistoryL(symList* data, int pos, int len) ;
	symList* getMemory(std::vector<Symbol*>* data, int pos, int len);
	symList2Vec2Map* divideData(std::vector<Symbol*>* Data);
	...
	symSet *getAOsethappendbyHistcout(symList2IntMap* Histcout);
